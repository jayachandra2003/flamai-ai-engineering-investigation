...
6. **Goodput Derivation Correction:** Refactored a pseudo-independent second goodput derivation into a clear distinction between exact wall-clock goodput ($200.92\text{ tok/s}$) and instantaneous decode-phase rate ($249.82\text{ tok/s}$), explicitly noting the dataset's logging limitations.
