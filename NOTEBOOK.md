...
| **Lowercasing Asymmetry** | `fertility.py:60`<br>`line.lower()` vs raw case | Cased eng: 25,741 tok<br>Cased hin: 191,828 tok | Lower eng: 26,696 tok<br>Lower hin: 191,842 tok | eng: **+3.71%**<br>hin: **+0.01%** | **PREPROCESSING CHOICE:** Lowercasing increases the measured English token count from 25,741 to 26,696 (+3.71%) in this corpus, while having negligible effect on Hindi (+0.01%). (Reverse relative difference: $\frac{25741 - 26696}{26696} = -3.58\%$). |
