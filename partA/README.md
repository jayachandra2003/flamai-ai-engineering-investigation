...
4. **Sample Size Scope:** While 997 sentences (~21,000 words per language) provide strong statistical power for fertility benchmarking compared to 10 sample sentences, it remains a sample and cannot guarantee exhaustive coverage of rare morphological inflections or technical vocabularies.
