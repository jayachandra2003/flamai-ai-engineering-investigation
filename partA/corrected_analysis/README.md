...
| **C. Tokens / Grapheme Cluster** | $\frac{\text{Tokens}}{\text{Graphemes}}$ | Tokenization density per Unicode extended grapheme cluster (`regex` `\X`). | Measures Unicode extended grapheme clusters produced by Unicode grapheme-cluster segmentation (`regex.findall(r'\X', text)`); not synonymous with an orthographic syllable or Indic akshara in every case. | Does not resolve multi-morpheme lexical density differences across languages. | **STRUCTURAL DIAGNOSTIC**. |
...
| | | **hin** | 191,828 | 7.80 | 1.529 | 2.328 | 0.595 | **7.45×** | **6.35×** |
| | | **kan** | 349,772 | 22.67 | 2.655 | 4.059 | 0.979 | **13.59×** | **18.45×** |
| | | **tel** | 335,642 | 20.48 | 2.639 | 4.562 | 0.991 | **13.04×** | **16.67×** |
| **Meta-Llama-3-8B** (128k scale) | 128,000 | **eng** | 25,792 | 1.23 | 0.206 | 0.206 | 0.206 | 1.00× | 1.00× |
| | | **hin** | 65,361 | 2.66 | 0.521 | 0.793 | 0.203 | **2.53×** | **2.16×** |
| | | **kan** | 229,014 | 14.84 | 1.738 | 2.658 | 0.641 | **8.88×** | **12.06×** |
| | | **tel** | 215,433 | 13.15 | 1.694 | 2.928 | 0.636 | **8.35×** | **10.68×** |
| **Qwen2.5-7B** (152k scale) | 151,643 | **eng** | 26,255 | 1.25 | 0.210 | 0.210 | 0.210 | 1.00× | 1.00× |
| | | **hin** | 116,701 | 4.74 | 0.930 | 1.416 | 0.362 | **4.45×** | **3.79×** |
| | | **kan** | 182,074 | 11.80 | 1.382 | 2.113 | 0.509 | **6.93×** | **9.42×** |
| | | **tel** | 185,113 | 11.30 | 1.456 | 2.516 | 0.546 | **7.05×** | **9.02×** |
| **XLM-RoBERTa-base** (250k scale) | 250,002 | **eng** | 28,995 | 1.38 | 0.232 | 0.232 | 0.231 | 1.00× | 1.00× |
| | | **hin** | 36,634 | 1.49 | 0.292 | 0.445 | 0.114 | **1.26×** | **1.08×** |
| | | **kan** | 39,602 | 2.57 | 0.301 | 0.460 | 0.111 | **1.37×** | **1.85×** |
| | | **tel** | 38,708 | 2.36 | 0.304 | 0.526 | 0.114 | **1.33×** | **1.71×** |
